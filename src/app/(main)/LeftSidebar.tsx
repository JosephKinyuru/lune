...
export default function LeftSidebar({
  ...
  return (
    <section className="sticky left-0 top-0 z-20 flex max-h-fit min-h-screen w-full max-w-72 flex-col bg-card px-0 pb-5 pt-4 dark:bg-black max-xl:w-20 max-xl:px-2 max-xs:hidden lg:pt-8 xl:px-4">
